  ...
  **********************************************************************
  ...
  def get_action(self, state):
    ...
    **********************************************************************
    ...
    # Writing the opening book in a txt file
    # DEBUG_INFO = open("opening_book.txt", "a")
    # for key in self.data:
    #   DEBUG_INFO.write(str(key) + ": " + str(self.data[key]) + "\n")
    # DEBUG_INFO.close()

    if state.ply_count <= 4 and state in self.data: # use opening book
